...
class ArticleReferenceRepository:
    ...
    def save_references(self, references: List[ArticleReference]) -> int:
        ...
        for ref in references:
            try:
                ...
                logger.error(f"Failed to save article reference {ref.key}/{ref.urlname}: {e}")
    ...
    def get_unprocessed_references(self, limit: Optional[int] = None) -> List[ArticleReference]:
