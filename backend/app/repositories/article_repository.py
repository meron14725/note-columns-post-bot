...
class ArticleRepository:
    ...
    def get_recent_articles(self, days: int = 7, limit: Optional[int] = None) -> List[Article]:
    ...
    def get_articles_by_category(self, category: str, limit: Optional[int] = None) -> List[Article]:
    ...
    def get_top_articles(self, limit: int = 10, days: Optional[int] = None) -> List[ArticleWithEvaluation]:
        ...
        """
        return self.get_articles_with_evaluations(
            min_score=0, 
            limit=limit, 
            days=days
        )
    ...
    def _row_to_article_with_evaluation(self, row: Dict[str, Any]) -> ArticleWithEvaluation:
