...
class EvaluationRepository:
    ...
    def save_evaluation(self, evaluation: Evaluation) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to save evaluation for article {evaluation.article_id}: {e}")
            return False
    ...
    def get_recent_evaluations(self, days: int = 7, limit: Optional[int] = None) -> List[Evaluation]:
    ...
    def get_evaluation_statistics(self, days: Optional[int] = None) -> Dict[str, Any]:
        ...
        return {
            ...
            "excellent_entertainment": len([s for s in entertainment_scores if s >= 25]),
        }
    ...
    def delete_evaluation(self, article_id: str) -> bool:
        ...
        try:
            ...
            if affected_rows > 0:
                ...
                logger.warning(f"No evaluation found to delete for article: {article_id}")
                return False
