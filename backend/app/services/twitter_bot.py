...
class TwitterBot:
    ...
    def _get_current_post_config(self, current_time: datetime) -> Optional[Dict[str, Any]]:
    ...
    async def _get_articles_for_post(self, post_config: Dict[str, Any]) -> List[ArticleWithEvaluation]:
        ...
        selection_criteria = self.posting_config.get("selection_criteria", {}).get(post_type, {})
    ...
    def _create_tweet_content(
        self, 
        articles: List[ArticleWithEvaluation], 
