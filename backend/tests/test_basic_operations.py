...
BATCH_SCRIPTS = [
    "backend/batch/daily_process.py",
    "backend/batch/post_to_twitter.py"
]
...
class TestDryRunExecution:
    ...
    def test_daily_process_dry_run(self):
        ...
        with patch("backend.app.services.scraper.NoteScraper") as mock_scraper, \
             ...
             patch("backend.app.utils.database.db_manager") as mock_db:
